...
// Mapping Params
extern const float surroundingKeyframeSearchRadius = 60.0; // key frame that is within n meters from current pose will be considerd for scan-to-map optimization (when loop closure disabled)
...
extern const int   historyKeyframeSearchNum = 30; // 2n+1 number of history key frames will be fused into a submap for loop closure
